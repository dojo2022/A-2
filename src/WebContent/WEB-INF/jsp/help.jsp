		...
		<section class="wrapper">
			<div class="container">
				<div class="content">
					...
					<p>
						●宣言とステップの追加方法<br> ①<img src="/killerQueen/img/icon/regist.png" width="15"
									height="15">を押すと宣言を登録、編集できる画面が表示されます。<br>
						②大きい目標である宣言とそれを達成するための小さい目標であるステップを追加することができます。<br>
						③<img src="/killerQueen/img/icon/add.png" width="15"
									height="15">を押すとさらにステップを追加することができます。<br>
					...
					<p>
						●既存宣言、ステップの編集方法<br> ①<img src="/killerQueen/img/icon/add.png" width="15"
									height="15">を押すと宣言、ステップの編集画面が表示されます。<br>
					...
					<p>
						...
						⑤🏷（ラベル）マークをクリックするとラベルが白から黒に変わる。<br> ●ブックマークの使用方法<br>
