...
<tr>
	<!-- タイムラインとブックマークのリンク -->
	<th bgcolor="#4b4b4b" width="300" height="30" class="thclass"onclick="location.href='/killerQueen/TimelineServlet'">タイムライン</th>
	<th bgcolor="#C6BEBA" width="300" height="30" class="thclass"onclick="location.href='/killerQueen/BookmarkServlet'">ブックマーク</th>
</tr>
</table>
